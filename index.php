...
<head>
	...
	<link rel="stylesheet" href="https://use.typekit.net/iar2ewy.css">
</head>
...
<body>
	<div id="mainWrapper">
		<main>
			<header>
				<div>
					<img src="assets/img/will-blue.jpg" alt="Will Muijrers">
				</div>

				<h1>Web developer & user experience designer</h1>
			</header>

			<p>Currently teaching front-end technologies at <a href="https://zuyd.nl/" target="_blank"><span>Zuyd Hogeschool</span></a>, former co-founder and developer at <a href="https://saus.co/" target="_blank"><span>Saus</span></a>.</p>
			...
			<footer>
				...
				<a href="mailto:hello@willmuijre.rs" class="cta">
